    ...
    <div className="min-h-screen bg-black text-white overflow-hidden" style={{ fontFamily: "'Outfit', sans-serif" }}>
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 pb-32 mt-6 relative z-10">
        <div className="grid grid-cols-6 gap-4 sm:gap-6">
          ...
          <div onClick={() => navigate('/sos')} className="bento-card col-span-6 lg:col-span-2 relative overflow-hidden rounded-2xl border border-red-900/40 bg-[#000000] hover:border-red-500/50 cursor-pointer transition-colors duration-300 group" style={{ minHeight: 336 }}>
          ...
          <div className="bento-card col-span-3 lg:col-span-2 relative overflow-hidden rounded-2xl border border-teal-900/30 bg-[#000000] hover:border-teal-500/40 transition-colors duration-300" style={{ minHeight: 336 }}>
            {/* Fingerprint SVG */}
          ...
          <div className="bento-card col-span-3 lg:col-span-2 relative overflow-hidden rounded-2xl border border-white/6 bg-[#000000] hover:border-blue-500/30 transition-colors duration-300" style={{ minHeight: 336 }}>
          ...
          {[
            ...
            <div key={i} className="bento-card col-span-3 relative overflow-hidden rounded-2xl border border-white/5 bg-[#000000] hover:bg-[#111111] transition-colors duration-300" style={{ minHeight: 224 }}>
              {visual}
          ...
          {[
            ...
            <div key={i} className="bento-card col-span-2 relative overflow-hidden rounded-2xl border border-white/5 bg-[#000000] hover:bg-[#111111] transition-colors duration-300" style={{ minHeight: 210 }}>
          ...
          <div className="bento-card col-span-3 relative overflow-hidden rounded-2xl border border-white/5 bg-[#000000] hover:bg-[#111111] transition-colors duration-300" style={{ minHeight: 224 }}>
            {/* Chart line trace */}
